...
class SubscribersServiceProvider implements ServiceProviderInterface
{
    ...
    public function boot(Application $app)
    {
        ...
        $dispatcher->addSubscriber(new PrivacySubscriber($app['users.groups.model'], $app['users.model'], $app['users.profile.model'], $app['users.invitations.model'], $app['tokenGenerator.service'], $app['social_host']));
    }
