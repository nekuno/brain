...
class LinkProcessorServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Application $app)
    {
	    ...
	    $app['api_consumer.link_processor.processor.facebook'] = $app->share(
		    function ($app) {
			    return new FacebookProcessor($app['userAggregator.service'], $app['api_consumer.link_processor.processor.scrapper'], $app['api_consumer.resource_owner.facebook'], new FacebookUrlParser(), $app['guzzle.client']);
		    }
	    );

	    $app['api_consumer.link_processor.processor.twitter'] = $app->share(
		    function ($app) {
			    return new TwitterProcessor($app['userAggregator.service'], $app['api_consumer.link_processor.processor.scrapper'], $app['api_consumer.resource_owner.twitter'], new TwitterUrlParser(), $app['guzzle.client']);
		    }
	    );
