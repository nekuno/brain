...
class MatchingModel
{
     ...
     * @throws \Exception
     */
    public function recalculateMatchingOfUserByAnswersWhenNewQuestionsAreAnswered($userId, array $questions)
    {
        ...
        foreach ($result as $row) {
            $this->getMatchingBetweenTwoUsersBasedOnAnswers($userId, $row['u']);
        }
    }
