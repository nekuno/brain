...
class LookUpManager
{
    ...
    public function setFromWebHook(Request $request)
    {
        ...
        if ($lookUpData = $this->em->getRepository('\Entity\LookUpData')->findOneBy(array('hash' => $hash))) {
    ...
    {
        $lookUpData = $this->em->getRepository('\Entity\LookUpData')->findOneBy($lookUpQuery);
