...
class Neo4jHandler extends AbstractHandler
{
    ...
    const SUBLEVEL_ERROR = 10;
    
    const SUBLEVEL_WARNING = 20;
    ...
    public function handle(array $record)
    {
        ...
        $sublevelString = isset($record['sublevel']) && $record['sublevel'] == static::SUBLEVEL_WARNING ? 'WARNNG' : 'ERROR';
        
        $string = '-------------------'.$sublevelString.'-------------------' . PHP_EOL .
