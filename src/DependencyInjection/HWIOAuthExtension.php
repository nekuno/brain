...
use DependencyInjection\HWIOAuthConfiguration as Configuration;
...
class HWIOAuthExtension extends Extension
{
    ...
    {
        $loader = new XmlFileLoader($container, new FileLocator(__DIR__.'/../../vendor/hwi/oauth-bundle/Resources/config/'));
        ...
        */
        ...
        $oauthUtils->addMethodCall('addResourceOwnerMap', array(new Reference('oauth.resource_owner_map')));
        ...
        $class = ResourceOwnerMap::class;
        $arguments = array(
            new Definition(HttpUtils::class),
            $config['resource_owners'],
            $resourceOwnersMap,
        );
        $definition = new Definition($class, $arguments);
        $definition->addMethodCall('setContainer', array(new Reference('service_container')));
        $container->setDefinition('oauth.resource_owner_map', $definition);
    }
