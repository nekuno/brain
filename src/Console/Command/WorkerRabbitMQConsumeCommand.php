    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        switch ($consumer) {
            ...
            case 'matching':
                /* @var $channel AMQPChannel */
                $channel = $connection->channel();
                $worker = new MatchingCalculatorWorker($channel, $this->app['users.model'], $this->app['users.matching.model'], $this->app['users.similarity.model'], $this->app['dbs']['mysql_social'], $this->app['dbs']['mysql_brain'], $this->app['dispatcher']);
                $worker->setLogger($logger);
