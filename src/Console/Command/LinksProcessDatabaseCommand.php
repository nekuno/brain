...
{
    protected static $defaultName = 'links:process:database';
    ...
    public function __construct(LoggerInterface $logger, LinkManager $linkManager, ProcessorService $processorService)
    {
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        do {
            ...
            $links = $this->linkManager->getLinks($conditions, $offset, $limit);
            ...
            $this->processorService->reprocess($preprocessedLinks);
