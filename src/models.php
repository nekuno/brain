...
$app['users.model'] = function ($app) {
    ...
    return new \Model\UserModel($app['neo4j.graph_manager'], $app['dbs']['mysql_social'], $app['orm.ems']['mysql_brain'], $app['fields']['user'], $app['locale.options']['default'], $app['dispatcher']);
};
